...
## results path
input_path <- "/GWAS/data/nov_gwas_staar_update/plt/snv/snv_5mask/step6_sliding_window_maf5percent/"
output_path <- "/GWAS/data/nov_gwas_staar_update/plt/snv/snv_5mask/summary/step6_sliding_window_maf5percent_1/"
## results name
sliding_window_results_name <- "plt_snv_Sliding_Window"
...
source("/all_Rscript/Sliding_Window_Results_Summary.R")
###########################################################
#           Main Function 
###########################################################
Sliding_Window_Results_Summary(agds_dir=agds_dir,jobs_num=jobs_num,
                               ...
                               obj_nullmodel=obj_nullmodel,known_loci=known_loci,cMAC_cutoff=cMAC_cutoff,rare_maf_cutoff=rare_maf_cutoff,
